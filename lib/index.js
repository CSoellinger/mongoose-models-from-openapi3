            ...
            if (!MongooseOpenApi3.loaded) {
                MongooseOpenApi3.loaded = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (openapiSpec instanceof openapi3_util_1.OpenApi3UtilClass) {
                        if (openapi3_util_1.OpenApi3Util.isValidSpec()) {
                            spec = openapi3_util_1.OpenApi3Util.specification;
                        ...
                        yield openapi3_util_1.OpenApi3Util.loadFromContent(openapiSpec).catch((e) => reject(e));
                        yield openapi3_util_1.OpenApi3Util.loadJsonSchema().catch((e) => reject(e));
                        yield openapi3_util_1.OpenApi3Util.dereference().catch((e) => reject(e));
                        yield openapi3_util_1.OpenApi3Util.resolveAllOf().catch((e) => reject(e));
                        if (openapi3_util_1.OpenApi3Util.isValidSpec()) {
                            spec = openapi3_util_1.OpenApi3Util.specification;
                            RegisterClass_1.RegisterClass
                                .registerModels(spec)
